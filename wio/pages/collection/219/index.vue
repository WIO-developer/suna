    ...
    <div class="container_column">
      ...
      <section class="hero__container">
          ...
          <div class="hero">
            ...
            <figure class="hero__media">
              <video muted="" loop="" autoplay="" playsinline="" class="hero__video" preload="auto">
                <source :src="storage_url + `/collection/home_main.mp4`" type="video/mp4">
              </video>
            </figure>
          </div>
        </div>
        ...
        <div class="hero__cols">
          <div class="hero__col"
            style="background-image:url('https://store.suna.company/images/collection/home_instagram.jpg'); background-size: cover; background-position: center;">
          ...
          <div class="hero__col hero__col-right"
            style=" background-image:url('https://store.suna.company/images/collection/home_store.jpg'); background-size: cover; background-position: center;">
            <figure class="hero-col">
